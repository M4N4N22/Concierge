...
export const MARKETPLACE_ADDRESSES: Record<number, string> = {
  16661: process.env.NEXT_PUBLIC_MARKETPLACE_ADDRESS as string,
  16602:
    (process.env.NEXT_PUBLIC_MARKETPLACE_TESTNET_ADDRESS ||
      process.env.NEXT_PUBLIC_MARKETPLACE_ADDRESS) as string,
};
